...
<div class="stat-cards" style="grid-template-columns:repeat(4,1fr);margin-bottom:24px;">
  <div class="stat-card">
    <div class="stat-icon" style="background:var(--gradient-black);"><span class="material-icons">login</span></div>
  ...
  <div class="stat-card">
    <div class="stat-icon" style="background:var(--gradient-black);"><span class="material-icons">receipt_long</span></div>
  ...
  <div class="stat-card">
    <div class="stat-icon" style="background:var(--gradient-black);"><span class="material-icons">payments</span></div>
